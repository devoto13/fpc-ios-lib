...
// ppcx64 -Tiphonesim foo.pas -XR/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator.sdk -WP11.0 && install_name_tool -id @loader_path/Frameworks/libfoo.dylib libfoo.dylib
// 
